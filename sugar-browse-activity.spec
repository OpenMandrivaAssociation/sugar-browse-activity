...
Source: http://download.sugarlabs.org/sources/sucrose/fructose/Browse/Browse-113.tar.bz2

Patch: sugar-browse-activity-113-sugar-456.patch

Requires: python-hulahop >= 0.5.2
Requires: python  
